...
/*!****************************!*\
  !*** ./src/js/requests.js ***!
  \****************************/
/*! exports provided: getDataWeatherByCity, getDataWeatherByLatLon */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getDataWeatherByCity\", function() { return getDataWeatherByCity; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getDataWeatherByLatLon\", function() { return getDataWeatherByLatLon; });\nconst getDataWeatherByCity = async (city, country) => {\n\tconst url = `https://api.openweathermap.org/data/2.5/weather?q=${city},${country}&units=metric&appid=${\"d62ad369b92353ed2c7fa12088d2688a\"}`;\n\tconst res = await fetch(url);\n\tconst data = await res.json();\n\treturn data;\n}\n\nconst getDataWeatherByLatLon = async (latitude, longitude) => {\n\tconst url = `https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&units=metric&appid=${\"d62ad369b92353ed2c7fa12088d2688a\"}`;\n\tconst res = await fetch(url);\n\tconst data = await res.json();\n\treturn data;\n}\n\n//# sourceURL=webpack:///./src/js/requests.js?");
